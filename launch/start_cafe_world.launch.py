...
def generate_launch_description():
    ...
    # Set the path to the WORLD model files. Is to find the models inside the models folder in barista_robot_gazebo package
    ...
    return LaunchDescription([
        DeclareLaunchArgument(
          'world',
          default_value=[os.path.join(pkg_barista_robot_gazebo, 'worlds', 'cafe.world'), ''],
